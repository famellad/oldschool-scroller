...
function love.conf(t)
    ...
    t.window.minwidth = 256 * 8/7 * 3              -- Minimum window width if the window is resizable (number)
    t.window.minheight = 224 * 3            -- Minimum window height if the window is resizable (number)
